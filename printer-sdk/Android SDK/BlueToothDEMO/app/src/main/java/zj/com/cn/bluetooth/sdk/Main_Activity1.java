...
public class Main_Activity1 extends Activity implements OnClickListener {
    /******************************************************************************************************/
    // Debugging
    ...
    private void checkPermissions(String... permissions) {
        ...
        if (null != needRequestPermissonList && needRequestPermissonList.size() > 0) {
            ActivityCompat.requestPermissions(Main_Activity1.this, needRequestPermissonList.toArray(
    ...
    private List<String> findDeniedPermissions(String[] permissions) {
        ...
        for (String perm : permissions) {
            if (ContextCompat.checkSelfPermission(Main_Activity1.this,perm) != PackageManager.PERMISSION_GRANTED) {
                needRequestPermissonList.add(perm);
            } else {
                if (ActivityCompat.shouldShowRequestPermissionRationale(Main_Activity1.this, perm)) {
                    needRequestPermissonList.add(perm);
                }
            }
        }
...
//        mTitle.setText(R.string.app_title);
        ...
        newDevicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                BluetoothDevice device = (BluetoothDevice) myadapter.getItem(position);
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if(!TextUtils.isEmpty(name) && name.contains("5809TEST")){
            ...
            case R.id.Send_Button: {
                if (hexBox.isChecked()) {
                    ...
                    if (str.length() > 0) {
                        ...
                        Toast.makeText(Main_Activity1.this, getText(R.string.empty), Toast.LENGTH_SHORT).show();
                    }
                } else {
...
//                                public void run() {
//                                    if(isReceive==false){
//                                        Toast.makeText(Main_Activity1.this,"打印失败!!!",Toast.LENGTH_SHORT).show();
//
//                                    }else{
//                                        Toast.makeText(Main_Activity1.this,"打印成功!!!",Toast.LENGTH_SHORT).show();
//                                    }
//
//                                    isReceive = false;
//                                }
...
/****************************************************************************************************/
    ...
    private void printBarCode() {
        ...
        new AlertDialog.Builder(Main_Activity1.this).setTitle(getText(R.string.btn_prtcode))
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {
                            if (str.length() == 11 || str.length() == 12) {
                                ...
                                Toast.makeText(Main_Activity1.this, getText(R.string.msg_error), Toast.LENGTH_SHORT).show();
                                return;
                            }
                        } else if (which == 1) {
                            ...
                            if (str.length() == 0) {
                                Toast.makeText(Main_Activity1.this, getText(R.string.empty1), Toast.LENGTH_SHORT).show();
                                return;
                            } else {
    ...
    private void CommandTest() {
        ...
        String lang = getString(R.string.strLang);
        if ((lang.compareTo("cn")) == 0) {
            new AlertDialog.Builder(Main_Activity1.this).setTitle(getText(R.string.chosecommand))
...
/****************************************************************************************************/
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(Main_Activity1.this,R.layout.device_item, null);
